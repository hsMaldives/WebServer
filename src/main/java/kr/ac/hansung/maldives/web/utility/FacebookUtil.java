...
public class FacebookUtil {
	...
	private static final String[] fields = { "id", "about", "age_range", "birthday", "context", "cover", "currency",
	...
	public static UserProfile fetchUserProfile(Facebook facebook) {
		...
		socialMediaProfile = new UserProfile(user.getId(), user.getName(), user.getFirstName(), user.getLastName(),
				user.getEmail(), null);
