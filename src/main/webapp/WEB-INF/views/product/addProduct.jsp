...
<div class="container-wrapper">
	<div class="container">
		<h1>Add Product</h1>
		<p class="lead">Fill the below information to add a products:</p>
		...
		<sf:form
			...
			<div class="form-group">
				...
				<sf:radiobutton path="category" name="category" value="컴퓨터" />
				컴퓨터
				<sf:radiobutton path="category" name="category" value="가전" />
				가전
				<sf:radiobutton path="category" name="category" value="신발" />
				신발
			</div>
